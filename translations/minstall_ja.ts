...
選択したインストールパーティションを含むディスクは問題があります。
    ...
    <message>
        ...
        <translation>antiX Linux ファイルシステムインストール準備</translation>
    </message>
    <message>
        <location filename="minstall.cpp" line="474"/>
        <source>OK to format and use the entire disk (%1) for antiX Linux?</source>
        <translation>antiX Linux を使用するために %1 をフォーマットしてよろしいですか？</translation>
    </message>
    <message>
...
全データを削除してよろしいですか？ OK で実施します。</translation>
    ...
    <message>
        ...
        <translation>すみません、GRUB のインストールに失敗しました。これはフォーマット形式の変化によって生じているかもしれません。GRUB のチェックを外して antiX Linux のインストールを進めて再起動した後、CD から GRUB 機能の再インストールするためのインストール復旧を行う事ができます。</translation>
    </message>
    <message>
...
Do you want to reboot now?</source>
        <translation>antiX Linux のインストールと設定が完了しました。
...
処理を止めてよろしいですか？</translation>
    ...
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;はじめに&lt;/b&gt;&lt;br/&gt;実行の前に他のアプリケーションを閉じて下さい。&lt;/p&gt;&lt;p&gt;各ページに表示される表示を読み、選択を行って下さい。進めてもよろしければ「次へ」を押して進めて下さい。&lt;/p&gt;&lt;p&gt;antiX Linux では 3.5 GB の空き容量が必要です。5 GB 以上が推奨されます。任意のディスクによるパーティション内で antiX Linux を使用する事ができます。&lt;/p&gt;&lt;p&gt;もしパソコンをご利用で、パーティション作業が必要であれば GParted を実行しパーティションを修正した後、カスタムインストールを使用して下さい。もし Apple 製のハードウェアを使用している場合は parted や GParted を起動ドライブで使用しないで下さい。antiX Linux をインストールする前に OS X または Windows OS (Vista 以降) からパーティションとブートマネージャの設定を行って下さい。&lt;/p&gt;&lt;p&gt;ファイルシステムは ext2、ext3、ext4、jfs、xfs、btrfs、reiserfs の Linux ファイルシステムに対応しています。ext4 が推奨されます。&lt;/p&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;無保証&lt;/b&gt;&lt;br/&gt;このソフトウェアは保証なしで提供されます。 データのバックアップを取って下さい。&lt;/p&gt;&lt;p&gt;&lt;b&gt;パーティション&lt;/b&gt;&lt;br/&gt;antiX はルートパーティションが必須です。また swap パーティションも作成でき、推奨されます。antiX でディスクを休ませるようにするには、swap パーティションを実際のメモリより大きい容量にして下さい。&lt;/p&gt;&lt;p&gt;ホームパーティションを別のパーティションで作成すると、将来的にアップグレードを容易に行う事ができます。&lt;/p&gt;&lt;p&gt;&lt;b&gt;更新&lt;/b&gt;&lt;br/&gt;すでにインストールしている Linux を更新する場合、ホームパーティションが存在すれば、それを選んで下さい。&lt;/p&gt;&lt;p&gt;もしルートパーティション内にホームディレクトリが存在する場合、ルートパーティションのフォーマットを行いません。この場合インストール作業は時間を要します。&lt;/p&gt;&lt;p&gt;&lt;b&gt;望ましいファイルシステムの種類&lt;/b&gt;&lt;br/&gt;antiX では ext2、ext3、ext4、jfs、xfs、btrfs、reiser をフォーマットの種類として選択できます。&lt;/p&gt;&lt;p&gt;&lt;b&gt;不良ブロック&lt;/b&gt;&lt;br/&gt;ext2、ext3、ext4 をフォーマット形式で選んだ場合、ドライブの不良ブロック確認するオプションを選択できます。不良ドライブの確認はとても時間を要します。ドライブに不良ブロックがある事を思われない限りはこの手順をスキップしても良いでしょう。&lt;/p&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;スペシャルサンクス&lt;/b&gt;&lt;br/&gt;時間、金銭、作業、賞賛、アイデアなど、antiX Linux を支援していただく皆様に感謝いたします。&lt;/p&gt;&lt;p&gt;あなたなしでは antiX Linux は存在しません。&lt;/p&gt;&lt;p&gt;anticapitalista, antiX and MX Linux Communities&lt;/p&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;インストール作業&lt;/b&gt;&lt;br/&gt;antiX Linux をインストールしています。フレッシュインストールの場合はおおよそ 3〜20 分要します。この速度はシステムやパーティション構成で変わります。&lt;/p&gt;&lt;p&gt;もし Abort ボタンを押した場合、はやいうちにインストールを止める事ができます。&lt;/p&gt;</translation>
    </message>
    <message>
...
Step 1 に処理を戻します。</translation>
    ...
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;任意サービス&lt;/b&gt;&lt;br/&gt;システム構成として必要な任意サービスを選択して下さい。これは antiX Linux が起動する時、自動的にサービス起動します。&lt;/p&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;デフォルトユーザーログイン&lt;/b&gt;&lt;br/&gt;root ユーザーは他の OS でいう Administrator ユーザーに類似します。root ユーザーをユーザーアカウントとして通常使用すべきではありません。通常使用するユーザーアカウントを入力して下さい。必要な場合は antiX ユーザーマネージャーで他のユーザーアカウントを後に追加する事ができます。&lt;/p&gt;&lt;p&gt;&lt;b&gt;パスワード&lt;/b&gt;&lt;br/&gt;ユーザーアカウントと root アカウントのパスワードを入力して下さい。このパスワードは2回入力する必要があります。&lt;/p&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;アプリケーションの検索&lt;/b&gt;&lt;br/&gt;antiX Linux には沢山の素晴らしいアプリケーションが入っています。まずはメニュー中を探索して下さい。多くのアプリは特に IceWM/fluxbox/jwm 環境のために作成されています。これはメインメニューから見る事ができます。&lt;p&gt;更に antiX Linux はコマンドラインから動作するメニューに表示されない標準の Linux アプリケーションを含めています。&lt;/p&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;antiX Linux を楽しんで使用して下さい！&lt;/b&gt;&lt;/p&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>acpi サポート</translation>
    </message>
    <message>
...
sure you want to Close now?</source>
        <translation>antiX Linux はインストール中です。
...
Returning to Step 1.</source>
        <translation>古い antiX Linux の削除に失敗しました。
Step 1 に処理を戻します。</translation>
    </message>
    <message>
...
Returning to Step 1.</source>
        <translation>antiX Linux の書き込みに失敗しました。
Step 1 へ処理を戻します。</translation>
    </message>
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;ヘルプを得る&lt;/b&gt;&lt;br/&gt;antiX Linux の基本的な情報は http://antix.mepis.com を参照して下さい。ボランティアが antiX フォーラム http://antix.freeforums.org であなたを助けるためにいます。&lt;/p&gt;&lt;p&gt;あなたが助けを求めるならば、少しでも問題と使用しているコンピュータの情報を詳細に記述するのを忘れないでください。通常「働きません」という内容は役に立ちません。&lt;/p&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;インストールの復旧&lt;/b&gt;&lt;br/&gt;もし antiX Linux が動作しない場合は、CD や USB から起動し、システム設定にあるユーティリティを実行するか、基本的な Linux ツールを使用してシステムを復旧させる事ができます。&lt;/p&gt;&lt;p&gt;マイクロソフト Windows で使用していたデータを復旧させるために antiX Linux の CD・USB メモリを使用する事も可能です。&lt;/p&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;antiX Linux のサポート&lt;/b&gt;&lt;br/&gt;antiX Linux はあなたのような皆様に支援されています。サポートフォーラム http://antix.freeforums.org https://forum.mxlinux.orgで他の人を助ける、使用している言語の翻訳作業を行う、ドキュメント作成を行う、新しいバージョンのテストを行う、といった支援が可能です。&lt;/p&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;音量調整&lt;/b&gt;&lt;br/&gt;antiX Linux は音楽ミキサーを備えます。たまに音を聞くため、ミキサーでチャンネル毎の音量調整が必要になるかもしれません。&lt;/p&gt; &lt;p&gt;ミキサーの素早い起動はメニューからミキサーをクリックして開いて下さい。 &lt;/p&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;antiX Linux の最新情報&lt;/b&gt;&lt;br/&gt;antiX Linux の最新情報はフォーラムを参照して下さい。 http://antix.freeforums.org https://forum.mxlinux.org &lt;/p&gt;</translation>
    </message>
    <message>
...
他の名前を入力して下さい。</translation>
    ...
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;スペシャルサンクス&lt;/b&gt;&lt;br/&gt;時間、金銭、作業、賞賛、アイデアなど、antiX Linux を支援していただく皆様に感謝いたします。&lt;/p&gt;&lt;p&gt;あなたなしでは antiX Linux は存在しません。&lt;/p&gt;&lt;p&gt;anticapitalista, Mepis and antiX Communities&lt;/p&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;antiX Linux のサポート&lt;/b&gt;&lt;br/&gt;antiX Linux はあなたのような皆様に支援されています。サポートフォーラム http://antix.freeforums.org http://forum.mepiscommunity.orgで他の人を助ける、使用している言語の翻訳作業を行う、ドキュメント作成を行う、新しいバージョンのテストを行う、といった支援が可能です。&lt;/p&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;antiX Linux の最新情報&lt;/b&gt;&lt;br/&gt;antiX Linux の最新情報はフォーラムを参照して下さい。 http://antix.freeforums.org http://forum.mepiscommunity.org &lt;/p&gt;</translation>
    </message>
</context>
<context>
    <name>MeInstall</name>
...
Enjoy using antiX Linux.</source>
        <translation>antiX Linux は Debian Stable をベースとした独立 Linux ディストリビューションです

antiX Linux は、Apache フリーライセンス下で公開されている MEPIS Linux からいくつかのコンポーネントを使用しています。いくつかの MEPIS コンポーネントは、antiX Linux 用に変更されています。
...
MX Linux をお楽しみ下さい。</translation>
    ...
    <message>
        ...
        <translation>antiX Linux および Windows 向けに GRUB をインストール</translation>
    </message>
    <message>
...
antiX Linux is supported by people like you. Some help others at the support forum, - http://antix.freeforums.org - https://forum.mxlinux.org, or translate help files into different languages, or make suggestions, write documentation, or help test new software.</source>
        <translation>antiX Linux のサポート

antiX Linux はあなたのような皆様に支援されています。サポートフォーラム http://antix.freeforums.org https://forum.mxlinux.orgで他の人を助ける、使用している言語の翻訳作業を行う、ドキュメント作成を行う、新しいバージョンのテストを行う、といった支援が可能です</translation>
    </message>
</context>
<context>
    <name>MeMain</name>
    <message>
        ...
        <translation>antiX Linux インストール</translation>
    </message>
    <message>
